...
"""
    ...
    summary = {
        ...
        "return_code": rc,
        "outputs": {
            "metrics_json": "digital/sta_postcts/metrics.json" if metrics else None,
            "log": "digital/sta_postcts/logs/openlane_sta_postcts.log",
            "openlane_run_dir": latest,
        },
    }
    _write(os.path.join(stage_dir, "sta_postcts_summary.json"), json.dumps(summary, indent=2))
    _write(os.path.join(stage_dir, "sta_postcts_summary.md"),
