...
def _gen_coverage_model(cov_spec: Dict[str, Any]) -> str:
    ...
    output_points = cov_spec["output_points"]
    input_points = cov_spec["input_points"]

    template = """\
"""Auto-generated lightweight functional coverage model for {top}
...
class CoverageModel:
    ...
    def summary(self):
        ...
        for group_name, source, target in [
